...
class HelperFunctions {
  ...
  static String sharedPreferenceSessionID = "SessionID";
...
// for login
  ...
  static Future<bool> saveSessionIDSharedPreference(String userEmail) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.setString(sharedPreferenceSessionID, userEmail);
  }
  ...
  static Future<String?> getSessionIDSharedPreference() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.getString(sharedPreferenceSessionID);
  }
