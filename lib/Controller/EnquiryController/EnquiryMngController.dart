      ...
      if (value.stcode! >= 200 && value.stcode! <= 210) {
        if (value.itemdata != null) {
          ...
          for (int i = 0; i < value.itemdata!.length; i++) {
            if (value.itemdata![i].Manager_Status_Tab!.toLowerCase() == 'assigned') {
            ...
            if (value.itemdata![i].Manager_Status_Tab!.toLowerCase() == 'unassigned') { 
            ...
            if (value.itemdata![i].Manager_Status_Tab!.toLowerCase() == 'lost') {
