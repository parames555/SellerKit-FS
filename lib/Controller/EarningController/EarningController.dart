...
class EarningController extends ChangeNotifier {
  ...
  List<EarningData1> earningData1 = [];
  List<EarningData1> get getearningData1 => earningData1;
              ...
              if (value.earning1data != null)
                {
                  ...
                  print(
                      "earningData1[0].monthEarning:${earningData1[0].monthEarning}"),
                  notifyListeners(),
                }
