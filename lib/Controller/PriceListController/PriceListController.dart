...
//// view all
  ...
  isselectedProductViewAll(int i) {
    if (viewAll[i].isselected == 0) {
      viewAll[i].isselected = 1;
      addProductViewAll(viewAll[i].category);
    //  isSelectedBPS();
    } else {
      viewAll[i].isselected = 0;
      removeProductViewAll(viewAll[i].category);
    }
  }
...
//segment view all
  ...
  isselectedSegmentViewAll(int i) {
    if (viewAll[i].isselected == 0) {
      viewAll[i].isselected = 1;
      addSegmentViewAll(viewAll[i].category);
     // isSelectedBPS();
    } else {
      viewAll[i].isselected = 0;
      removeSegmentViewAll(viewAll[i].category);
    }
    notifyListeners();
  }
