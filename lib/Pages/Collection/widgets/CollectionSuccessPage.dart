...
import 'package:sellerkit/Pages/Collection/widgets/Receipt.dart';
...
class CollectionSuccessPage extends StatefulWidget {
  CollectionSuccessPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          key: scaffoldKey,
          appBar: appbar("New Collection Entry", theme, context),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Center(
                              child: Text(
                            "Collection Entry Created Successfully",
                        ...
                        Container(
                          ...
                          child: Center(
                              child: Text(
                            "${context.read<NewCollectionContoller>().paymentmode} Amount Rs.${context.read<NewCollectionContoller>().mycontroller[5].text.toString()}",
                            style: theme.textTheme.bodyText2,
                            textAlign: TextAlign.center,
                          )),
                        ),
