        ...
        child: Row(
         ...
         // Colors.white60
                  ...
                  SizedBox(height: Screens.bodyheight(context)*0.01,),
                   Container(
              child: Text( "₹ ${prdern.getearningData1[0].monthEarning.toString()}",
          ...
          //  SizedBox(width: Screens.bodyheight(context)*0.02,),
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: Screens.bodyheight(context)*0.01,),
                   Container(
              child: Text( "₹ ${prdern.getearningData1[0].todayEarning.toString()}",  style: theme.textTheme.subtitle1?.copyWith(color: Colors.white,fontWeight: FontWeight.bold),
             ),
            )
                ],
              ),
