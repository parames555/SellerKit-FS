                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                width: Screens.width(context) * 0.4,
                                child: Text(
                                    "${context.watch<VisitplanController>().missedVisitUserdata[i].customer}",
                              ...
                              Container(
                                ...
                                width: Screens.width(context) * 0.4,
                                child: Text(
                                    "${context.watch<VisitplanController>().missedVisitUserdata[i].datetime}",
                                    style: theme.textTheme.bodyText2?.copyWith(
                                      color: theme.primaryColor,
                                      //fontWeight: FontWeight.bold
                                    )),
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  width: Screens.width(context) * 0.4,
                                  child: Text(
                                      "${context.watch<VisitplanController>().missedVisitUserdata[i].purpose}",
                                      style: theme.textTheme.bodyText2?.copyWith(
                                        color: theme.primaryColor,
                                        //fontWeight: FontWeight.bold
                                      )),
                              ...
                              Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: Screens.width(context) * 0.54,
                                    child: Text(
                                        "${context.watch<VisitplanController>().missedVisitUserdata[i].product!}",
                                        //"₹ ${context.watch<EnquiryUserContoller>().getopenEnqData[i].PotentialValue}",
                                        style:
                                            theme.textTheme.bodyText2?.copyWith(
                                          color: theme.primaryColor,
                              ...
                              Container(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                        "${context.watch<VisitplanController>().missedVisitUserdata[i].type}",
                                        style: theme.textTheme.bodyText2
                                            ?.copyWith(
