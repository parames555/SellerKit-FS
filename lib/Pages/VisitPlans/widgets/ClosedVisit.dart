                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                width: Screens.width(context) * 0.4,
                                child: Text(
                                    "${context.watch<VisitplanController>().closedVisitdata[i].customer}",
                              ...
                              Container(
                                ...
                                width: Screens.width(context) * 0.4,
                                child: Text(
                                    "${context.watch<VisitplanController>().closedVisitdata[i].datetime}",
                                    style: theme.textTheme.bodyText2?.copyWith(
                                      color: theme.primaryColor,
                                      //fontWeight: FontWeight.bold
                                    )),
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  width: Screens.width(context) * 0.4,
                                  child: Text(
                                      "${context.watch<VisitplanController>().closedVisitdata[i].purpose}",
                                      style: theme.textTheme.bodyText2?.copyWith(
                                        color: theme.primaryColor,
                                        //fontWeight: FontWeight.bold
                                      )),
                                ...
                                Container(
                                  ...
                                  width: Screens.width(context) * 0.4,
                                  child: Text(
                                      "${context.watch<VisitplanController>().closedVisitdata[i].area!}",
                              ...
                              Container(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                        "${context.watch<VisitplanController>().closedVisitdata[i].type}",
                                        style: theme.textTheme.bodyText2
                                            ?.copyWith(
