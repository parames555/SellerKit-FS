...
class FollowDialog extends StatefulWidget {
  FollowDialog({Key? key, required this.index}) : super(key: key);
  final int index;
  @override
                        ...
                        child: Text(
                          "Worth of Rs." +
                              context
                                  ...
                                  .config
                                  .slpitCurrency2(
                                    "${context.watch<LeadTabController>().getleadDeatilsQTHData[0].DocTotal!.toStringAsFixed(0)}",
                                  ) +'/-',
                  ...
                  Container(
                      ...
                      child: Column(
                              ...
                              child: Text(
                                'Next Follow up # ' +
                                    context.watch<LeadTabController>().config.alignDate(
                                        '${context.watch<LeadTabController>().getleadDeatilsLeadData[
                                          context.watch<LeadTabController>().getleadDeatilsLeadData.length - 1
                                          ].NextFollowup_Date}'
                                          ),
                                textAlign: TextAlign.center,
                                style: theme.textTheme.bodyText2?.copyWith(
                        ...
                        child: Container(
                          alignment: Alignment.center,
                          child: Text(
                            'Last status # ${context.watch<LeadTabController>().
                            getleadDeatilsLeadData[context.watch<LeadTabController>().getleadDeatilsLeadData.length - 1].Status}',
                            textAlign: TextAlign.center,
                            style: theme.textTheme.bodyText2?.copyWith(
                              color: theme.primaryColor,
                            ),
