        ...
        children: [
          Expanded(
            child: ListView.builder(
              itemCount: context.read<SettlementController>().cardList.length,
              itemBuilder: (BuildContext context, int i) {
                return InkWell(
                  onTap: () {
                    context.read<SettlementController>().iselectMethodCard(
                          i,
                        );
                  },
                  child: Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                width: Screens.width(context) * 0.4,
                                child: Text(
                                    "${context.watch<SettlementController>().cardList[i].cusstomer}",
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                    "${context.watch<SettlementController>().cardList[i].collectionDate}",
                                    style: theme.textTheme.bodyText2?.copyWith(
                                      color: theme.primaryColor,
                                      //fontWeight: FontWeight.bold
                                    )),
                          ...
                          //       // color: Colors.amber,
                          //       child: Checkbox(
                          //         value:context.read<SettlementController>().cardList[i].isselect,
                          //         onChanged: (value) {
                          //           // setState(() {
                          //             context
                          //                 .read<SettlementController>()
                          //                 .iselectMethodCard(i,value!);
                          //             // context
