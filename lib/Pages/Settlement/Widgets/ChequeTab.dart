        ...
        children: [
          Expanded(
            child: ListView.builder(
              itemCount: context.read<SettlementController>().chequeList.length,
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                width: Screens.width(context) * 0.4,
                                child: Text(
                                    "${context.watch<SettlementController>().chequeList[i].cusstomer}",
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                    "${context.watch<SettlementController>().chequeList[i].collectionDate}",
                                    style: theme.textTheme.bodyText2?.copyWith(
                                      color: theme.primaryColor,
                                      //fontWeight: FontWeight.bold
                                    )),
                          ...
                          //       // color: Colors.amber,
                          //       child: Checkbox(
                          //         value:context.read<SettlementController>().chequeList[i].isselect,
                          //         onChanged: (value) {
                          //           // setState(() {
                          //             context
                          //                 .read<SettlementController>()
                          //                 .iselectMethodCheque(i,value!);
                          //             // context
