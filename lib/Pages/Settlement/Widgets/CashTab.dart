...
class CashTabPage extends StatelessWidget {
  const CashTabPage({
    Key? key,
    required this.theme,
  }) : super(key: key);
        ...
        children: [
          Expanded(
            child: ListView.builder(
              itemCount: context.read<SettlementController>().cashList.length,
              itemBuilder: (BuildContext context, int i) {
                return InkWell(
                  onTap: () {
                    context.read<SettlementController>().iselectMethodCash(
                          i,
                        );
                  },
                  child: Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                width: Screens.width(context) * 0.4,
                                child: Text(
                                    "${context.watch<SettlementController>().cashList[i].cusstomer}",
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                    "${context.watch<SettlementController>().cashList[i].collectionDate}",
                                    style: theme.textTheme.bodyText2?.copyWith(
                                      color: theme.primaryColor,
                                      //fontWeight: FontWeight.bold
                                    )),
                          ...
                          //       // color: Colors.amber,
                          //       child: Checkbox(
                          //         value:context.read<SettlementController>().cashList[i].isselect,
                          //         onChanged: (value) {
                          //           // setState(() {
                          //             context
                          //                 .read<SettlementController>()
                          //                 .iselectMethodCash(i,value!);
                          //             // context
