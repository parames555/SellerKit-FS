  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          key: scaffoldKey,
          appBar: appbar("New Settlement", theme, context),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Center(
                              child: Text(
                            "Settlement Entry Created Successfully",
                        ...
                        Container(
                          ...
                          child: Center(
                              child: Text(
                            "DD Amount Rs.${context.read<SettlementController>().totalDD()}",
                            style: theme.textTheme.bodyText2,
                            textAlign: TextAlign.center,
                          )),
                        ),
