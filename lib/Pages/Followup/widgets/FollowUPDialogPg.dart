...
class FollowUPDialogPG extends StatefulWidget {
   FollowUPDialogPG({Key? key,required this.index, required this.followUPListData}) :super(key: key) ;
  int index;
...
class _FollowUPDialogPGState extends State<FollowUPDialogPG> {
  ...
  Widget build(BuildContext context) {
   final theme = Theme.of(context);
    ...
    Container CallDialog(BuildContext context, ThemeData theme,FollowupController fUPCon) {
    return Container(
  ...
  Container displayDialog(BuildContext context, ThemeData theme,FollowupController fUPCon) {
    return Container(
  ...
  Container detailsDialog(BuildContext context, ThemeData theme,FollowupController fUPCon) {
    return Container(
      width: Screens.width(context),
...
//forwad dialog
    Container forwardDialog(BuildContext context, ThemeData theme,FollowupController fUPCon) {
    return Container(
      width: Screens.width(context),
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(8),
  ...
  List<Widget> listContainersProduct(ThemeData theme,FollowupController fUPCon) {
    return List.generate(
...
//open close won update dialog
  ...
  Container UpdateFollowup(BuildContext context, ThemeData theme,FollowupController fUPCon) {
    return Container(
      width: Screens.width(context),
      child: SingleChildScrollView(
        child: Column(
