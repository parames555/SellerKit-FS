...
class _ScoreCardScreenOneState extends State<ScoreCardScreenOne> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        key: scaffoldKey,
        appBar: appbar("Score Card 1", theme, context),
        drawer: drawer3(context),
        body: ChangeNotifierProvider<ScoreCardController>(
                ...
                return SafeArea(
                    child: prdSCD.getscorecardDataExcep.isEmpty &&
                        ...
                        : prdSCD.getscorecardDataExcep.isNotEmpty &&
                            ...
                            ? Center(child: Text(prdSCD.getscorecardDataExcep))
